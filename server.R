...
server <- function(input, output, session) {
  ...
  source(file="./ServerPart/prePedPart.R", local = TRUE)
  ...
  source(file="./ServerPart/completenessPart.R", local = TRUE)
  ...
  source(file="./ServerPart/inbreedingPart.R", local=TRUE)
  ...
  source(file="./ServerPart/breedCompPart.R", local=TRUE)
  ...
  source(file="./ServerPart/pedSummaryPart.R", local=TRUE)
  ...
  source(file="./ServerPart/filterAgeContLPart.R", local=TRUE)
  ...
  source(file="./ServerPart/pedKinPart.R", local=TRUE)
  ...
  # source(file="./ServerPart/pedKinAtNPart.R", local=TRUE)
