...
# ===CANDIDATES DESCRIPTION ================================================================================================
  ...
  observeEvent(input$btn_candes,{
    ...
    #print(paste("It came here 4", class(PkinatN))
    if (nrow(PkinatNof)==0) {
      ShowPkinatNError()
      return(NULL)
    }
    ...
    candOG <- candes(phen=Phen, pKin=Pkin, pKinatN=PkinatN, cont=AgeContrib, quiet=as.logical(input$candes_quiet))
    # 
